...
namespace RPGEditor
{
    ...
    public class RPGEditorWindow : OdinMenuEditorWindow
    {
        ...
        protected override OdinMenuTree BuildMenuTree()
        {
            ...
            // Adds all characters.
            tree.AddAllAssetsAtPath("Characters", "Assets", typeof(Character), true, true);

            // Add all scriptable object items.
            tree.AddAllAssetsAtPath("", "Assets/RPG Editor/Items", typeof(Item), true)
            ...
            //tree.EnumerateTree().AddIcons<Character>(x => x.Prefab);
